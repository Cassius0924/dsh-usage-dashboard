...
export const zh = {
  ...
  'settings.widgetHint': '当前额度页已展示完整数据，悬浮窗会自动隐藏；切回 Chat 或 Trajectory 后恢复。',
...
export const en: Record<LocaleKey, string> = {
  ...
  'settings.widgetHint': 'The widget hides while this full dashboard is open, then returns on Chat or Trajectory.',
